...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var React=__webpack_require__(41);var ModalHeader=__webpack_require__(216);var ModalBody=__webpack_require__(217);var ModalFooter=__webpack_require__(229);var Modal=React.createClass({displayName:'Modal',childContextTypes:{translations:React.PropTypes.object},getChildContext:function getChildContext(){return{translations:this.props.translations};},propTypes:{dataSource:React.PropTypes.object.isRequired,translations:React.PropTypes.object.isRequired,columns:React.PropTypes.array.isRequired},componentDidMount:function componentDidMount(){jQuery(".btn-blue").corner('15px');function onResize(){var calculatedModalBodyHeight=$(window).height()-70;if(calculatedModalBodyHeight<490){calculatedModalBodyHeight=490;}$('#search-grid .modal-body').css('height',calculatedModalBodyHeight+'px');var gridSize=calculatedModalBodyHeight-$('#search-grid .filter-place').height()-$('#search-grid .staff-grid-header').height()-30;$('#search-grid .staff-table').height(gridSize);}$(window).resize(onResize);onResize();},render:function render(){return React.createElement('div',{className:'modal',id:this.props.id,role:'dialog'},React.createElement('div',{className:'modal-dialog modal-fluid'},React.createElement('div',{className:'modal-content'},React.createElement(ModalHeader,{translations:this.props.translations}),React.createElement(ModalBody,{columns:this.props.columns,dataSource:this.props.dataSource}))));}});module.exports=Modal;

/***/ },
/* 216 */
/***/ function(module, exports, __webpack_require__) {

	"use strict";var React=__webpack_require__(41);var ModalHeader=React.createClass({displayName:"ModalHeader",propTypes:{translations:React.PropTypes.object.isRequired},render:function render(){return React.createElement("div",{className:"modal-header"},React.createElement("div",{className:"title"},React.createElement("h4",null,this.props.translations.modal_title)));}});module.exports=ModalHeader;

/***/ },
/* 217 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var React=__webpack_require__(41);var FilterRow=__webpack_require__(218);var SortableRow=__webpack_require__(224);var Grid=__webpack_require__(226);var ModalBody=React.createClass({displayName:'ModalBody',propTypes:{dataSource:React.PropTypes.object.isRequired,columns:React.PropTypes.array.isRequired},getInitialState:function getInitialState(){return{filters:{},sort:{}};},onFilterChange:function onFilterChange(field,value){var filters=this.state.filters;filters[field]=value;this.setState({filters:filters});},onSortChange:function onSortChange(field,orderType){var sort=this.state.sort;sort.field=field;sort.orderType=orderType;this.setState({sort:sort});},render:function render(){return React.createElement('div',{className:'modal-body'},React.createElement('div',{className:'col-lg-12 grid grid-full-height'},React.createElement(FilterRow,{dataSource:this.props.dataSource,columns:this.props.columns,onFilterChange:this.onFilterChange}),React.createElement(SortableRow,{dataSource:this.props.dataSource,columns:this.props.columns,onSortChange:this.onSortChange}),React.createElement(Grid,{sort:this.state.sort,filters:this.state.filters,columns:this.props.columns,dataSource:this.props.dataSource,tickets:this.props.dataSource.getTicketsFiltered()})));}});module.exports=ModalBody;

/***/ },
/* 218 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var React=__webpack_require__(41);var FilterColumn=__webpack_require__(219);var FilterRow=React.createClass({displayName:'FilterRow',propTypes:{columns:React.PropTypes.array.isRequired,onFilterChange:React.PropTypes.func.isRequired},render:function render(){var columns=this.props.columns.map(function(column){return React.createElement(FilterColumn,{dataSource:this.props.dataSource,key:column.field,onFilterChange:this.props.onFilterChange,options:column.options?column.options:this.props.dataSource.getListByField(column.field),colSize:column.colSize,field:column.field,disableAutocomplete:column.disableAutocomplete,type:column.filterType});}.bind(this));return React.createElement('div',{className:'filter-place clearfix'},columns);}});module.exports=FilterRow;

/***/ },
/* 219 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var React=__webpack_require__(41);var DropDown=__webpack_require__(220);var InputAutocomplete=__webpack_require__(223);var FilterColumn=React.createClass({displayName:'FilterColumn',propTypes:{options:React.PropTypes.array.isRequired,colSize:React.PropTypes.number.isRequired,type:React.PropTypes.string.isRequired,field:React.PropTypes.string.isRequired,onFilterChange:React.PropTypes.func.isRequired},contextTypes:{translations:React.PropTypes.object},handleChange:function handleChange(){var value=this.refs.filterInput.value;this.props.onFilterChange(this.props.field,value);},render:function render(){var colSize=this.props.colSize;var mainClassName='col-lg-'+colSize+' col-md-'+colSize+' col-sm-'+colSize+' col-xs-'+colSize+' nopadding';var html=React.createElement('div',{className:mainClassName});switch(this.props.type){case'empty':{break;}case'textbox':{if(this.props.disableAutocomplete){html=React.createElement('div',{className:mainClassName},React.createElement('div',{className:'filter-item'},React.createElement('input',{ref:'filterInput',onChange:this.handleChange,type:'text',className:'form-control filter-input',placeholder:this.context.translations.all})));}else{html=React.createElement('div',{className:mainClassName},React.createElement(InputAutocomplete,{options:this.props.options,field:this.props.field,onFilterChange:this.props.onFilterChange}));}break;}case'multiselect':{html=React.createElement('div',{className:mainClassName},React.createElement(DropDown,{options:this.props.options,field:this.props.field,onFilterChange:this.props.onFilterChange}));break;}default:{break;}}return html;}});module.exports=FilterColumn;

/***/ },
/* 220 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var React=__webpack_require__(41);var OpenerBtn=__webpack_require__(221);var DropList=__webpack_require__(222);var DropDown=React.createClass({displayName:'DropDown',propTypes:{options:React.PropTypes.array.isRequired,field:React.PropTypes.string.isRequired,onFilterChange:React.PropTypes.func.isRequired},componentDidMount:function componentDidMount(){$('body').on('click',this.resetDropdown);},resetDropdown:function resetDropdown(e){if(($(e.target).hasClass('dropdown-toggle')||$(e.target).parent(".dropdown-toggle").length)&&!$(e.target).parents("."+this.state.fieldName).length){this.setState({opened:false});return;}var openerBtnNotClicked=!$(e.target).hasClass('dropdown-toggle')&&!$(e.target).parent(".dropdown-toggle").length;var dropDwonElementNotClicked=!$(e.target).hasClass('dropdown-element')&&!$(e.target).parent(".dropdown-element").length;if(openerBtnNotClicked&&dropDwonElementNotClicked){this.setState({opened:false});}},getInitialState:function getInitialState(){var state={opened:false,fieldName:this.props.field};state.selectedItems=[];return state;},toggleButton:function toggleButton(){this.setState({opened:!this.state.opened});},itemClick:function itemClick(id){var selecteds=this.state.selectedItems;var index=selecteds.indexOf(id);if(index===-1){selecteds.push(id);}else{selecteds.splice(index,1);}this.setState({selectedItems:selecteds});this.props.onFilterChange(this.props.field,selecteds);},render:function render(){var options=this.props.options;return React.createElement('div',{className:'filter-item '+this.state.fieldName},React.createElement('div',{className:'multiple-filter-select'},React.createElement('div',{className:'btn-group'},React.createElement(OpenerBtn,{onClick:this.toggleButton,options:options,selecteds:this.state.selectedItems},' '),React.createElement(DropList,{handleItemClick:this.itemClick,selecteds:this.state.selectedItems,options:this.props.options,opened:this.state.opened}))));}});module.exports=DropDown;

/***/ },
/* 221 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var React=__webpack_require__(41);var OpenerBtn=React.createClass({displayName:'OpenerBtn',contextTypes:{translations:React.PropTypes.object},propTypes:{selecteds:React.PropTypes.array.isRequired,onClick:React.PropTypes.func.isRequired},render:function render(){var selectedItems=this.props.selecteds;var buttonText=this.context.translations.all;if(selectedItems.length){if(selectedItems.length==this.props.options.length){buttonText=this.context.translations.all;}else{buttonText=selectedItems.length+(' '+this.context.translations.selected);}}return React.createElement('button',{type:'button',onClick:this.props.onClick,className:'btn btn-default dropdown-toggle'},buttonText,' ',React.createElement('span',{className:'caret'}));}});module.exports=OpenerBtn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	}else if(e.keyCode==13){this.handleSelect(options[this.state.active]);}}},filterList:function filterList(options){var limit=0;var search=this.state.search;if(search){search=search.toLowerCase();}return options.filter(function(option){if(limit>10){return false;}var found=true;if(typeof option=='string'){option=option.toLowerCase();}if(option.indexOf(search)===-1){found=false;}if(found){limit++;}return found;}.bind(this));},// highlight: function(option){
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var React=__webpack_require__(41);var GridColumn=__webpack_require__(227);var GridRow=__webpack_require__(228);var Grid=React.createClass({displayName:'Grid',componentDidMount:function componentDidMount(){jQuery('#scroll-wrapper').scrollbar();},isFilterFound:function isFilterFound(ticket,filter){ticket+='';return ticket.toLowerCase().indexOf(filter.toLowerCase())===-1;},filterTickets:function filterTickets(tickets,filters,sort){tickets=tickets.filter(function(ticket){var found=true;var isTicketExistInFilter;for(var i in filters){if(!filters[i]){continue;}ticket[i]=ticket[i]||'';//multiselect filter
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var React=__webpack_require__(41);var GridColumn=React.createClass({displayName:'GridColumn',propTypes:{id:React.PropTypes.any,colSize:React.PropTypes.number.isRequired,field:React.PropTypes.string.isRequired,link:React.PropTypes.string},render:function render(){var colSize=this.props.colSize;var mainClassName='col-lg-'+colSize+' col-md-'+colSize+' col-sm-'+colSize+' col-xs-'+colSize+' nopadding';var content=this.props.children;if(this.props.link){content=React.createElement('a',{target:'_blank',href:this.props.link},this.props.children);}return React.createElement('div',{'data-id':this.props.id,className:mainClassName},React.createElement('div',{className:'grid-col-item '+this.props.field},React.createElement('div',{className:'grid-staff-name pull-left'},content)));}});module.exports=GridColumn;
...
/***/ }
/******/ ]);
//# sourceMappingURL=search_grid.bundle.js.map