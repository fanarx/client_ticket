...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var React=__webpack_require__(41);var FilterRow=__webpack_require__(214);var SortableRow=__webpack_require__(219);var Grid=__webpack_require__(221);var ModalBody=React.createClass({displayName:'ModalBody',propTypes:{dataSource:React.PropTypes.object.isRequired,columns:React.PropTypes.array.isRequired},getInitialState:function getInitialState(){return{filters:{},sort:{}};},onFilterChange:function onFilterChange(field,value){var filters=this.state.filters;filters[field]=value;this.setState({filters:filters});},onSortChange:function onSortChange(field,orderType){var sort=this.state.sort;sort.field=field;sort.orderType=orderType;this.setState({sort:sort});},render:function render(){return React.createElement('div',{className:'modal-body'},React.createElement('div',{className:'col-lg-12 grid grid-full-height'},React.createElement(FilterRow,{dataSource:this.props.dataSource,columns:this.props.columns,onFilterChange:this.onFilterChange}),React.createElement(SortableRow,{dataSource:this.props.dataSource,columns:this.props.columns,onSortChange:this.onSortChange}),React.createElement(Grid,{sort:this.state.sort,filters:this.state.filters,columns:this.props.columns,dataSource:this.props.dataSource,tickets:this.props.dataSource.getTicketsFiltered()})));}});module.exports=ModalBody;

/***/ },
/* 214 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var React=__webpack_require__(41);var FilterColumn=__webpack_require__(215);var FilterRow=React.createClass({displayName:'FilterRow',propTypes:{columns:React.PropTypes.array.isRequired,onFilterChange:React.PropTypes.func.isRequired},render:function render(){var columns=this.props.columns.map(function(column){return React.createElement(FilterColumn,{key:column.field,onFilterChange:this.props.onFilterChange,options:column.options?column.options:[],colSize:column.colSize,field:column.field,type:column.filterType});}.bind(this));return React.createElement('div',{className:'filter-place clearfix'},columns);}});module.exports=FilterRow;

/***/ },
/* 215 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var React=__webpack_require__(41);var DropDown=__webpack_require__(216);var FilterColumn=React.createClass({displayName:'FilterColumn',propTypes:{options:React.PropTypes.array.isRequired,colSize:React.PropTypes.number.isRequired,type:React.PropTypes.string.isRequired,field:React.PropTypes.string.isRequired,onFilterChange:React.PropTypes.func.isRequired},contextTypes:{translations:React.PropTypes.object},handleChange:function handleChange(){var value=this.refs.filterInput.value;this.props.onFilterChange(this.props.field,value);},render:function render(){//debugger;
	var colSize=this.props.colSize;var mainClassName='col-lg-'+colSize+' col-md-'+colSize+' col-sm-'+colSize+' col-xs-'+colSize+' nopadding';var html=React.createElement('div',{className:mainClassName});switch(this.props.type){case'empty':{break;}case'textbox':{html=React.createElement('div',{className:mainClassName},React.createElement('div',{className:'filter-item'},React.createElement('input',{ref:'filterInput',onChange:this.handleChange,type:'text',className:'form-control filter-input',placeholder:this.context.translations.all})));break;}case'multiselect':{html=React.createElement('div',{className:mainClassName},React.createElement(DropDown,{options:this.props.options,field:this.props.field,onFilterChange:this.props.onFilterChange}));break;}default:{break;}}return html;}});module.exports=FilterColumn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	}else if(filters[i]&&this.isFilterFound(ticket[i],filters[i])){found=false;break;}}return found;}.bind(this));var sortArray=Object.keys(sort);if(sortArray.length){tickets.sort(function(ticket1,ticket2){if(sort.orderType==true){var object1=ticket1;var object2=ticket2;}else{var object1=ticket2;var object2=ticket1;}if(Number(object1[sort.field])&&Number(object2[sort.field])){object1[sort.field]=Number(object1[sort.field]);object2[sort.field]=Number(object2[sort.field]);};if(object1[sort.field]>object2[sort.field]){return 1;}else if(object1[sort.field]<object2[sort.field]){return-1;}return 0;});}return tickets;},render:function render(){var tickets=this.filterTickets(this.props.tickets,this.props.filters,this.props.sort);var rows=tickets.map(function(ticket){var columns=this.props.columns.map(function(column,idx){//console.log('idx', idx);
	var optionalProps={};if(column.link&&column.link==true){optionalProps.link='https://'+ticket.instanceMessage+'/ticket/'+ticket.id;}return React.createElement(GridColumn,_extends({key:ticket.id+"_"+idx,id:ticket[column.field],colSize:column.colSize},optionalProps,{field:column.field}),' ',ticket[column.contentField],' ');}.bind(this));return React.createElement(GridRow,{key:ticket.id},columns);}.bind(this));return React.createElement('div',{id:'scroll-wrapper',className:'staff-table clearfix'},rows);}});module.exports=Grid;
